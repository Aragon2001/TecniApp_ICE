...
data class AveriaEntity(
    ...
    val materialesDetalleJson: String? = null,  // JSON serializado de materiales
    val tecnicosAtendieronJson: String? = null, // JSON serializado de técnicos que atendieron
